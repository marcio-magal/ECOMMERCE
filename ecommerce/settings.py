...
SECRET_KEY = 'django-insecure-1gmq7iyl*dphhjuwjbm-ie*6%z%!l9+ld5fzl9ru+34-)#okd#'
...
INSTALLED_APPS = [
    ...
    'cadastroProduto.apps.CadastroprodutoConfig',
    'cadastroCliente.apps.CadastroclienteConfig',
